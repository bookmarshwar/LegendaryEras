...
public class CokingFurnaceScreen extends AbstractContainerScreen<CokingFurnaceMenu> {
    private  static  final ResourceLocation TEXTURE = new ResourceLocation(Main.MOD_ID,"textures/gui/dbian2.png");
    public CokingFurnaceScreen(CokingFurnaceMenu menu, Inventory inventory, Component component) {
    ...
    private void renderProgressArrow(PoseStack pPoseStack, int x, int y) {
        if(menu.isCrafting()){
            blit(pPoseStack,x+105,y+33,176,0,8, 26);
        }
    }
