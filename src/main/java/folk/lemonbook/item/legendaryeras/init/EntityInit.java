...
public class EntityInit {
    ...
    public static final RegistryObject<BlockEntityType<CokingFurnaceEntity>> COKING_FURNACE_ENTITY=BLOCK_ENTITIES.register("coking_furnace_entity",()->BlockEntityType.Builder.of(CokingFurnaceEntity::new,BlockInit.COKING_FURNACE.get()).build(null));
}
